      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin TabDlg.SSTab SSTab1 
               ...
               Tab(1).Control(1)=   "chkTracciaImballoGest"
               Tab(1).Control(2)=   "chkConfermaDaUtente"
               Tab(1).Control(3)=   "txtLottoImballoGest"
               Tab(1).Control(4)=   "cmdLottoImballo"
               Tab(1).Control(5)=   "cmdRiepilogoLottoImballo"
               Tab(1).Control(6)=   "txtQuantitaImballo"
               Tab(1).Control(7)=   "cmdNuovoImballo"
               Tab(1).Control(8)=   "cmdSalvaImballo"
               Tab(1).Control(9)=   "cmdEliminaImballo"
               Tab(1).Control(9).Enabled=   0   'False
               Tab(1).Control(10)=   "GrigliaImballi"
               Tab(1).Control(11)=   "CDImballoGestione"
               Tab(1).Control(12)=   "cboTipoProcessoImballo"
               Tab(1).Control(13)=   "cboUMImbGest"
               Tab(1).Control(14)=   "txtDispLottoImballo"
               Tab(1).Control(15)=   "txtGiacLottoImballo"
               ...
               Tab(2).Control(0)=   "cmdNuovoAddebiti"
               Tab(2).Control(1)=   "cmdSalvaAddebiti"
               Tab(2).Control(2)=   "cmdEliminaAddebiti"
               Tab(2).Control(2).Enabled=   0   'False
               Tab(2).Control(3)=   "GrigliaAddebiti"
               Tab(2).Control(4)=   "CDArticoliAddebiti"
               Tab(2).Control(5)=   "cboIvaAddebiti"
               Tab(2).Control(6)=   "txtAliquotaIvaAddebiti"
               Tab(2).Control(7)=   "cboTipoTrattenutaAggiuntiva"
               Tab(2).Control(8)=   "txtTotaleRigaAddebiti"
               Tab(2).Control(9)=   "txtImpostaAddebiti"
               Tab(2).Control(10)=   "txtImponibileAddebiti"
               Tab(2).Control(11)=   "txtImpUniAddebiti"
               Tab(2).Control(12)=   "txtQtaAddebiti"
               Tab(2).Control(13)=   "Label2(33)"
               Tab(2).Control(14)=   "Label2(32)"
               Tab(2).Control(15)=   "Label2(31)"
               Tab(2).Control(16)=   "Label2(30)"
               Tab(2).Control(17)=   "Label2(29)"
               Tab(2).Control(18)=   "Label6(2)"
               Tab(2).Control(19)=   "Label2(28)"
               Tab(2).Control(20)=   "Label2(27)"
