      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin TabDlg.SSTab SSTab1 
               ...
               Tab(0).Control(1)=   "txtPercorsoEtiPDF"
               Tab(0).Control(2)=   "chkStampaEtiPDF"
               Tab(0).Control(3)=   "chkVisEtiPedUtente"
               Tab(0).Control(4)=   "chkVisEtiLavUtente"
               Tab(0).Control(5)=   "cmdEliminaRifOrdIVGammaLav"
               Tab(0).Control(6)=   "cmdEliminaRifOrdIVGamma"
               Tab(0).Control(7)=   "cmdOrdIVGammaLav"
               Tab(0).Control(8)=   "cmdOrdIVGamma"
               Tab(0).Control(9)=   "txtIDOrdineIVGamma"
               Tab(0).Control(10)=   "chkStampaNuovoMetodo"
               Tab(0).Control(11)=   "txtNumeroEtichettePedana"
               Tab(0).Control(12)=   "chkStampaPedana"
               Tab(0).Control(13)=   "cboListinoImballiDefault"
               Tab(0).Control(14)=   "CDTipoPedana"
               Tab(0).Control(15)=   "txtDataOrdinePred"
               Tab(0).Control(16)=   "txtNumeroOrdinePred"
               Tab(0).Control(17)=   "CDClienteOrdinePred"
               Tab(0).Control(18)=   "cboUMRigaOrdine"
               Tab(0).Control(19)=   "txtDataOrdIVGamma"
               Tab(0).Control(20)=   "txtNOrdIVGamma"
               Tab(0).Control(21)=   "CDClienteOrdIVGamma"
               Tab(0).Control(22)=   "txtDataOrdIVGammaLav"
               Tab(0).Control(23)=   "txtNOrdIVGammaLav"
               Tab(0).Control(24)=   "CdClienteIVGammaLav"
               Tab(0).Control(25)=   "txtIDOrdineIVGammaLav"
               Tab(0).Control(26)=   "cboSezListaPrelievo"
               Tab(0).Control(27)=   "txtNListaOrdinePred"
               Tab(0).Control(28)=   "txtNListaOrdIVGamma"
               Tab(0).Control(29)=   "txtNOrdListaIVGammaLav"
               Tab(0).Control(30)=   "Line1"
               Tab(0).Control(31)=   "Label23(2)"
               Tab(0).Control(32)=   "Label4(11)"
               Tab(0).Control(33)=   "Label4(10)"
               Tab(0).Control(34)=   "Label4(9)"
               Tab(0).Control(35)=   "Label23(1)"
               Tab(0).Control(36)=   "Label15(6)"
               Tab(0).Control(37)=   "Shape1(6)"
               Tab(0).Control(38)=   "Label15(5)"
               Tab(0).Control(39)=   "Label4(8)"
               Tab(0).Control(40)=   "Label4(7)"
               Tab(0).Control(41)=   "Label15(4)"
               Tab(0).Control(42)=   "Label4(6)"
               Tab(0).Control(43)=   "Label4(5)"
               Tab(0).Control(44)=   "Label4(3)"
               Tab(0).Control(45)=   "Label15(3)"
               Tab(0).Control(46)=   "Label14"
               Tab(0).Control(47)=   "Label4(0)"
               Tab(0).Control(48)=   "Label4(1)"
               Tab(0).Control(49)=   "Label4(2)"
               Tab(0).Control(50)=   "Label15(0)"
               Tab(0).Control(51)=   "Label15(1)"
               Tab(0).Control(52)=   "Shape1(0)"
               Tab(0).Control(53)=   "Shape1(4)"
               Tab(0).Control(54)=   "Shape1(5)"
