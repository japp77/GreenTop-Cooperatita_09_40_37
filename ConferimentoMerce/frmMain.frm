      ...
      Begin VB.PictureBox PicForm 
         ...
         Begin VB.PictureBox PicForm2 
            ...
            Begin VB.Frame FraOrdineCliente 
               ...
               Begin DmtCodDescCtl.DmtCodDesc cdCliente 
                  ...
                  BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  PropDescrizione =   $"frmMain.frx":4854C
            ...
            Begin VB.Frame Frame1 
               ...
               Begin DmtCodDescCtl.DmtCodDesc CDSocioFatt 
                  ...
                  BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  PropDescrizione =   $"frmMain.frx":496E4
                  BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  MenuFunctions   =   $"frmMain.frx":49749
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
            ...
            Begin TabDlg.SSTab SSTab1 
               ...
               _Version        =   393216
               TabHeight       =   520
               TabCaption(0)   =   "MERCE CONFERITA"
               TabPicture(0)   =   "frmMain.frx":52F5D
               Tab(0).ControlEnabled=   -1  'True
               Tab(0).Control(0)=   "fraRighe"
               Tab(0).Control(0).Enabled=   0   'False
               Tab(0).ControlCount=   1
               TabCaption(1)   =   "GESTIONE ALTRI IMBALLI"
               TabPicture(1)   =   "frmMain.frx":52F79
               Tab(1).ControlEnabled=   0   'False
               Tab(1).Control(0)=   "txtLottoImballoRifEsterno"
               Tab(1).Control(0).Enabled=   0   'False
               Tab(1).Control(1)=   "cmdRiepilogoLottoImballo"
               Tab(1).Control(1).Enabled=   0   'False
               Tab(1).Control(2)=   "chkConfermaDaUtente"
               Tab(1).Control(2).Enabled=   0   'False
               Tab(1).Control(3)=   "txtDispLottoImballo"
               Tab(1).Control(3).Enabled=   0   'False
               Tab(1).Control(4)=   "txtGiacLottoImballo"
               Tab(1).Control(4).Enabled=   0   'False
               Tab(1).Control(5)=   "cmdLottoImballo"
               Tab(1).Control(5).Enabled=   0   'False
               Tab(1).Control(6)=   "txtLottoImballoGest"
               Tab(1).Control(6).Enabled=   0   'False
               Tab(1).Control(7)=   "chkTracciaImballoGest"
               Tab(1).Control(7).Enabled=   0   'False
               Tab(1).Control(8)=   "txtQuantitaImballo"
               Tab(1).Control(8).Enabled=   0   'False
               Tab(1).Control(9)=   "cmdNuovoImballo"
               Tab(1).Control(9).Enabled=   0   'False
               Tab(1).Control(10)=   "cmdSalvaImballo"
               Tab(1).Control(10).Enabled=   0   'False
               Tab(1).Control(11)=   "cmdEliminaImballo"
               Tab(1).Control(11).Enabled=   0   'False
               Tab(1).Control(12)=   "GrigliaImballi"
               Tab(1).Control(12).Enabled=   0   'False
               Tab(1).Control(13)=   "CDImballoGestione"
               Tab(1).Control(13).Enabled=   0   'False
               Tab(1).Control(14)=   "cboTipoProcessoImballo"
               Tab(1).Control(14).Enabled=   0   'False
               Tab(1).Control(15)=   "cboUMImbGest"
               Tab(1).Control(15).Enabled=   0   'False
               Tab(1).Control(16)=   "txtIDLottoImballoGest"
               Tab(1).Control(16).Enabled=   0   'False
               Tab(1).Control(17)=   "txtImpUniAltriImb"
               Tab(1).Control(17).Enabled=   0   'False
               Tab(1).Control(18)=   "Label2(45)"
               Tab(1).Control(18).Enabled=   0   'False
               Tab(1).Control(19)=   "Label2(41)"
               Tab(1).Control(19).Enabled=   0   'False
               Tab(1).Control(20)=   "Label2(38)"
               Tab(1).Control(20).Enabled=   0   'False
               Tab(1).Control(21)=   "Label2(35)"
               Tab(1).Control(21).Enabled=   0   'False
               Tab(1).Control(22)=   "Label2(34)"
               Tab(1).Control(22).Enabled=   0   'False
               Tab(1).Control(23)=   "Label2(26)"
               Tab(1).Control(23).Enabled=   0   'False
               Tab(1).ControlCount=   24
               TabCaption(2)   =   "GESTIONE ALTRI ADDEBITI"
               TabPicture(2)   =   "frmMain.frx":52F95
               ...
               Begin VB.Frame fraRighe 
                  ...
                  Begin VB.Frame FraLottoCampagna 
                     ...
                     Top             =   120
                     Width           =   17175
                     Begin DMTEDITNUMLib.dmtNumber txtIDSfalcioLotto 
                        Height          =   255
                        Left            =   16200
                        TabIndex        =   266
                        Top             =   120
                        ...
                        Appearance      =   1
                     End
                     Begin VB.CommandButton cmdSelSfalcio 
                        Caption         =   "..."
                        BeginProperty Font 
                           Name            =   "Arial"
                           Size            =   8.25
                        ...
                        TabIndex        =   265
                        TabStop         =   0   'False
                        ToolTipText     =   "Seleziona sfalcio"
                        Top             =   360
                        Width           =   420
                     End
                     Begin VB.TextBox txtSfalcio 
                        Enabled         =   0   'False
                        Height          =   315
                        Left            =   15120
                        TabIndex        =   263
                  ...
                  Begin DmtCodDescCtl.DmtCodDesc CDCodiceImballo 
                     ...
                     BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     PropDescrizione =   $"frmMain.frx":561E2
                     BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        Name            =   "Arial"
                        Size            =   8.25
                        Charset         =   0
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     MenuFunctions   =   $"frmMain.frx":56239
                     BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        Name            =   "Verdana"
                        Size            =   8.25
                        Charset         =   0
                  ...
                  Begin DmtCodDescCtl.DmtCodDesc CDArticolo 
                     ...
                     BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     PropDescrizione =   $"frmMain.frx":562E2
                     BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        Name            =   "Arial"
                        Size            =   8.25
                        Charset         =   0
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     MenuFunctions   =   $"frmMain.frx":56339
                     BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        Name            =   "Verdana"
                        Size            =   8.25
                        Charset         =   0
                  ...
                  Begin DmtCodDescCtl.DmtCodDesc CDPedana 
                     ...
                     BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     PropDescrizione =   $"frmMain.frx":563E9
                     BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        Name            =   "Verdana"
                        Size            =   8.25
                        Charset         =   0
                        ...
                        Strikethrough   =   0   'False
                     EndProperty
                     MenuFunctions   =   $"frmMain.frx":56440
                     BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                        Name            =   "Verdana"
                        Size            =   8.25
                        Charset         =   0
               ...
               Begin DmtCodDescCtl.DmtCodDesc CDImballoGestione 
                  ...
                  BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  PropDescrizione =   $"frmMain.frx":564E9
                  BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  MenuFunctions   =   $"frmMain.frx":56548
                  BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
               ...
               Begin DmtCodDescCtl.DmtCodDesc CDArticoliAddebiti 
                  ...
                  BeginProperty PropCodiceFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     ...
                     Strikethrough   =   0   'False
                  EndProperty
                  PropDescrizione =   $"frmMain.frx":565F1
                  BeginProperty PropDescrizioneFontCaption {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                     Name            =   "Verdana"
                     Size            =   8.25
                     Charset         =   0
...
If Me.cboSezionale.CurrentID = 0 Then
    MsgBox "Inserire il sezionale", vbCritical, "Validazione dati"
...
'    m_Semaphore.SetObjectAction m_DocType.ID, SemAllObjects, SemInsertAction
    ...
    Me.chkPreConferimento.Enabled = False
    Me.chkPreConferimento.Value = vbUnchecked
...
Private Function fnFillDocTypeCondition() As String
    ...
    m_DocType.Fields("IDTipoDocumentoCoop").Value = 1
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Else
        ...
        Me.cboTipoLavorazione.Width = 3375
    End If
        ...
        If Not Field.PrimaryKey Then
            ...
            Else
                ...
                If Field.Name = "PreConferimento" Then
                    Field.Value = 0
                End If
                If Field.Name = "TrattaComeConferimento" Then
                    Field.Value = 1
                End If
...
AGGIORNAMENTO_SFALCI fnNotNullN(m_Document(m_Document.PrimaryKey).Value)
...
CONTROLLO_MOVIMENTAZIONE_CONFERIMENTO fnNotNullN(m_Document(m_Document.PrimaryKey))
...
Dim AvvioFormAttesa As Boolean
    ...
    If fnMsgQuestion(gResource.GetCustomizedMessage(MESS_QUERYREMOVE), m_App.FunctionName) = vbYes Then
        ...
        If ControlloRigheMovimentate = False Then
            MsgBox "Impossibile eliminare il documento poichè alcuni lotti del documento risultano movimentati da altri documenti", vbCritical, "Controllo eliminazione"
            Exit Sub
        End If
        
        If ControlloRigheMovimentateCampionatura = False Then
            MsgBox "Impossibile eliminare il documento poichè alcuni lotti del documento risultano movimentati nella campionatura", vbCritical, "Controllo eliminazione"
            Exit Sub
        End If
        
        If ControlloRigheMovimentateLottiImballo = True Then
            MsgBox "Impossibile eliminare il documento poichè alcuni lotti imballi del documento risultano movimentati nella campionatura", vbCritical, "Controllo eliminazione"
            Exit Sub
        End If
        If Me.chkPreConferimento.Value = vbChecked Then
            MsgBox "Questo documento è stato generato da un pre-conferimento pertanto è impossibile da eliminare", vbCritical, "Controllo eliminazione"
            Exit Sub
        End If
...
On Error GoTo ERR_cboIVA_Click
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
Exit Sub
ERR_cboIVA_Click:
    MsgBox Err.Description, vbCritical, "cboIVA_Click"
End Sub
...
On Error GoTo ERR_CDSocio_ChangeElement
...
If Not rs.EOF Then
    ...
    txtNomeSocio = fnNotNull(rs!Nome)
Else
...
Exit Sub
ERR_CDSocio_ChangeElement:
    MsgBox Err.Description, vbCritical, "CDSocio_ChangeElement"
End Sub
...
If fnNotNullN(m_DocumentsLink2("IDRV_POAssegnazioneMerce").Value) > 0 Then
    
    Testo = "ATTENZIONE!!!" & vbCrLf
    Testo = Testo & "Questo addebito è collegato ad una riga di lavorazione" & vbCrLf
    Testo = Testo & "Continuando con questo comando ci potrebbero essere delle incongruenze con le liquidazioni" & vbCrLf
    Testo = Testo & "Vuoi continuare?"
    
    If MsgBox(Testo, vbQuestion, "Gestione altri addebiti") = vbNo Then Exit Sub
...
On Error GoTo ERR_cmdGestioneQualita_Click
    ...
    SaveSetting REGISTRY_KEY, "RV_POQualitaGestioneNew", "IDTipoQualitaGestione", "4"
...
On Error GoTo ERR_cmdLavorazioneAutomatica_Click
Dim Testo As String
...
Exit Sub
ERR_cmdLavorazioneAutomatica_Click:
    MsgBox Err.Description, vbCritical, "cmdLavorazioneAutomatica_Click"
End Sub
...
Exit Sub
ERR_cmdNuovo_Click:
    MsgBox Err.Description, vbCritical, "ERR_cmdNuovo_Click"
End Sub
...
On Error GoTo ERR_cmdNuovoImballo_Click
    If Me.chkPreConferimento.Value = vbChecked Then Exit Sub
    If fnNotNullN(m_Document(m_Document.PrimaryKey).Value) <= 0 Then Exit Sub
...
Exit Sub
ERR_cmdNuovoImballo_Click:
    MsgBox Err.Description, vbCritical, "cmdNuovoImballo_Click"
End Sub
...
On Error GoTo ERR_cmdRiepilogo_Click
    If fnNotNullN(m_Document(m_Document.PrimaryKey).Value) <= 0 Then Exit Sub
    
    If fnNotNullN(m_DocumentsLink(m_DocumentsLink.PrimaryKey).Value) <= 0 Then Exit Sub
    
    Link_RigaConferimento = fnNotNullN(Me.GrigliaCorpo("IDRV_POCaricoMerceRighe").Value)
    
    frmRiepilogo.Show vbModal
Exit Sub
ERR_cmdRiepilogo_Click:
    MsgBox Err.Description, vbCritical, "cmdRiepilogo_Click"
End Sub
...
If PermessoSalvataggio = True Then
    ...
    Else
        ...
        m_DocumentsLink("IDRV_PO01_LottoCampagnaSfalcio").Value = Me.txtIDSfalcioLotto.Value
...
'If GET_ESISTENZA_BIO = True Then
    ...
    Me.txtIDSfalcioLotto.Value = 0
    If ATTIVA_OBBLIGO_SFALCIO = 1 Then
        cmdSelSfalcio_Click
    End If
...
Private Sub cmdSelSfalcio_Click()
    If GET_CONTROLLO_GEST_SFALCI(LINK_FAMIGLIA_LOTTO_CAMPAGNA) = 0 Then Exit Sub
    If Me.chkPreConferimento.Value = vbChecked Then Exit Sub
    
    LINK_LOTTO_PRODUZIONE_SEL = Me.txtIDLottoCampagna.Value
    
    frmSelSfalcio.Show vbModal
    
    'ATTIVA SELEZIONE SFALCIO
...
'INIZIALIZZAZIONE DEL DOCUMENTO
    ...
    ADD_PESATURE_CONFERIMENTO fnNotNullN(m_Document(m_Document.PrimaryKey))
...
If AggiornamentoDocumento = 0 Then
    If Not (m_DocumentsLink.BOF And m_DocumentsLink.EOF) Then
        ...
        Me.txtIDSfalcioLotto.Value = fnNotNullN(m_DocumentsLink("IDRV_PO01_LottoCampagnaSfalcio").Value)
        bValue = True
...
'        Me.txtTotaleRiga.Enabled = bValue
   ...
   End If
    ...
    Me.txtCollegamentoRigaOrdine.Text = GET_DESCRIZIONE_COLLEGAMENTO(fnNotNullN(m_DocumentsLink("IDValoriOggettoDettaglioOrdine").Value))
    'fnTotaleRiga
    GET_RIEPILOGO_PESI
End If
End Sub
...
Private Sub txtAliquotaIVA_Change()
    'fnTotaleRiga
End Sub
...
On Error Resume Next
    ...
    Else
        If Me.txtDataConferimento.Value > 0 Then
            ...
            If Me.txtDataConferimento.Text <> fnNotNull(m_Document("DataConferimento").Value) Then
                Me.txtIDLetteraIntento.Value = GET_LINK_LETTERA_INTENTO_PRED(Me.CDSocio.KeyFieldID, 3, Me.txtDataConferimento.Text, TheApp.IDFirm)
            End If
        End If
    End If
...
Private Sub txtIDSfalcioLotto_Change()
On Error GoTo ERR_txtIDSfalcioLotto_Change
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

Me.txtSfalcio.Text = ""

sSQL = "SELECT RV_PO01_LottoCampagnaSfalcio.IDRV_PO01_LottoCampagnaSfalcio, RV_PO01_LottoCampagnaSfalcio.IDRV_PO01_LottoCampagna, RV_PO01_LottoCampagnaSfalcio.IDRV_PO01_Sfalcio, "
sSQL = sSQL & "RV_PO01_Sfalcio.Sfalcio "
sSQL = sSQL & "FROM RV_PO01_LottoCampagnaSfalcio INNER JOIN "
sSQL = sSQL & "RV_PO01_Sfalcio ON RV_PO01_LottoCampagnaSfalcio.IDRV_PO01_Sfalcio = RV_PO01_Sfalcio.IDRV_PO01_Sfalcio "
sSQL = sSQL & "WHERE RV_PO01_LottoCampagnaSfalcio.IDRV_PO01_LottoCampagnaSfalcio=" & Me.txtIDSfalcioLotto.Value

Set rs = Cn.OpenResultset(sSQL)

If Not rs.EOF Then
    Me.txtSfalcio.Text = fnNotNull(rs!Sfalcio)
End If

rs.CloseResultset
Set rs = Nothing
Exit Sub
ERR_txtIDSfalcioLotto_Change:
    MsgBox Err.Description, vbCritical, "txtIDSfalcioLotto_Change"
End Sub
...
'        ParametroAttivaImportoRiepConf
    ...
    If Len(m_App.Caller) > 0 And m_App.CallerFieldValue > 0 Then
        ...
        LINK_RIGA_CONFERIMENTO_DA_MOV = Val(GetSetting(REGISTRY_KEY, App.EXEName, "IDRigaConferimento"))   '12665
...
Me.ProgressBar1.Max = 100
    ...
    If (Mov.Delete) = False Then
        SalvataggioRighe = False
        MsgBox Mov.ErrInsideDescription, vbCritical, "Errore eliminazione movimenti"
        Set Mov = Nothing
        Screen.MousePointer = 0
        Exit Function
    End If
...
End If
If ATTIVA_OBBLIGO_SFALCIO = 1 Then
    If Me.txtIDSfalcioLotto.Value = 0 Then
        Testo = "ATTENZIONE!!!" & vbCrLf
        Testo = Testo & "Lo sfalcio del lotto di produzione è obbligatorio." & vbCrLf
...
'If fnNotNullN(m_DocumentsLink(m_DocumentsLink.PrimaryKey).Value) > 0 Then
'    If GET_CONTROLLO_QUANTITA_CAMPIONATA(fnNotNullN(m_DocumentsLink(m_DocumentsLink.PrimaryKey).Value), Me.txtQta_UM.Value) = False Then
'        MsgBox "La quantità conferita non può essere minore della quantità campionata", vbCritical, "Impossibile salvare"
'        PermessoSalvataggio = False
'        Exit Function
'    End If
'End If
...
On Error GoTo ERR_AGGIORNA_DATA_DI_LIQUIDAZIONE
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset
...
Set rs = Nothing
Exit Sub
ERR_AGGIORNA_DATA_DI_LIQUIDAZIONE:
    MsgBox Err.Description, vbCritical, "AGGIORNA_DATA_DI_LIQUIDAZIONE"
End Sub
...
sSQL = "SELECT IDRV_POCaricoMerceRighe, IDRV_POCaricoMerceTesta, IDRV_POLottoImballo, TracciaImballo, Colli, IDImballo, TracciaImballo, LottoImballoUtilizzoEsclusivo "
sSQL = sSQL & "FROM RV_POCaricoMerceRighe "
...
While Not rs.EOF
    If ((fnNotNullN(rs!TracciaImballo) = 1)) Then 'And (fnNotNullN(rs!IDRV_POLottoImballo) = 0)) Then
        ...
        fnNotNullN(rs!Colli), IDTipoOggetto, IDAnagrafica, fnNotNullN(rs!IDImballo), DataDocumento, NumeroDocumento, CodiceSocio, fnNotNullN(rs!LottoImballoUtilizzoEsclusivo)
    End If
rs.MoveNext
Wend
...
End Sub
Private Sub GENERA_SALDO_IMBALLI(IDAnagrafica As Long, DataInizio As String, DataFine As String)
...
If Not rs.EOF Then
    ...
    GET_DESCRIZIONE_COLLEGAMENTO = GET_DESCRIZIONE_COLLEGAMENTO & "Ordine del cliente "
    GET_DESCRIZIONE_COLLEGAMENTO = GET_DESCRIZIONE_COLLEGAMENTO & fnNotNull(rs!Nom_ragione_sociale_o_cognome) & " " & fnNotNull(rs!Nom_nome)
    GET_DESCRIZIONE_COLLEGAMENTO = GET_DESCRIZIONE_COLLEGAMENTO & " n° " & fnNotNull(rs!Doc_Numero)
    GET_DESCRIZIONE_COLLEGAMENTO = GET_DESCRIZIONE_COLLEGAMENTO & " del " & fnNotNull(rs!Doc_data)

Else
    If (IDRigaOrdine > 0) Then
        GET_DESCRIZIONE_COLLEGAMENTO = GET_DESCRIZIONE_COLLEGAMENTO & "Generato da una riga di ordine, ma il collegamento è stato perso "
    End If
End If
...
If Not rs.EOF Then
    ...
    ATTIVA_OBBLIGO_SFALCIO = fnNotNullN(rs!ObbligatorioRifSfalcioConf)
    ATTIVA_SEQUENZA_SFALCIO = fnNotNullN(rs!ObbligatorioSequenzaSfalcioConf)
Else
    Link_TipoSocio = 0
    Link_TipoImballo = 0
    Link_TipoGrezzo = 0
    ...
    ABILITA_TAB_CONF = 0
    IDSOCIO_PRE_CONF = 0
    ATTIVA_OBBLIGO_N_DOC_SOCIO = 0
    ATTIVA_OBBLIGO_SFALCIO = 0
    ATTIVA_SEQUENZA_SFALCIO = 0
End If
...
End Sub
Private Function GET_CONTROLLO_GEST_SFALCI(IDFamiglia As Long) As Long
Dim sSQL As String
Dim rs As DmtOleDbLib.adoResultset

GET_CONTROLLO_GEST_SFALCI = 0

sSQL = "SELECT IDRV_PO01_FamigliaProdotti, AttivaGestioneSfalci "
...
If Not rs.EOF Then
    GET_CONTROLLO_GEST_SFALCI = Abs(fnNotNullN(rs!AttivaGestioneSfalci))
End If

rs.CloseResultset
Set rs = Nothing
End Function
Private Sub AGGIORNAMENTO_SFALCI(IDConferimento As Long)
On Error GoTo ERR_AGGIORNAMENTO_SFALCI
Dim sSQL As String
Dim rsSfalcio As ADODB.Recordset
Dim rs As DmtOleDbLib.adoResultset

sSQL = "SELECT IDRV_POCaricoMerceRighe, IDRV_PO01_LottoCampagnaSfalcio "
sSQL = sSQL & "FROM RV_POCaricoMerceRighe "
sSQL = sSQL & "WHERE IDRV_POCaricoMerceTesta=" & IDConferimento
...
While Not rs.EOF
    If fnNotNullN(rs!IDRV_PO01_LottoCampagnaSfalcio) > 0 Then
        sSQL = "SELECT * FROM RV_PO01_LottoCampagnaSfalcio "
        sSQL = sSQL & "WHERE IDRV_PO01_LottoCampagnaSfalcio=" & fnNotNullN(rs!IDRV_PO01_LottoCampagnaSfalcio)
        
        Set rsSfalcio = New ADODB.Recordset
        
        rsSfalcio.Open sSQL, Cn.InternalConnection, adOpenKeyset, adLockPessimistic
        
        If Not rsSfalcio.EOF Then
            If fnNotNullN(rsSfalcio!DataEffettivaInizio) = 0 Then
                rsSfalcio!DataEffettivaInizio = Date
                rsSfalcio.Update
                
                sSQL = "UPDATE RV_PO01_LottoCampagna SET "
                sSQL = sSQL & "DataUltimoAggiornamento=" & fnNormDate(Now)
                sSQL = sSQL & " WHERE IDRV_PO01_LottoCampagna=" & fnNotNullN(rsSfalcio!IDRV_PO01_LottoCampagna)
                Cn.Execute sSQL
            End If
        End If
        
        rsSfalcio.Close
        Set rsSfalcio = Nothing
    End If
rs.MoveNext
Wend
...
Set rs = Nothing
Exit Sub
ERR_AGGIORNAMENTO_SFALCI:
    MsgBox Err.Description, vbCritical, "AGGIORNAMENTO_SFALCI"
End Sub
